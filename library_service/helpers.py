...
def register_with_consul():
    ...
    service_id   = os.getenv("SERVICE_ID", "library-service")
    service_name = os.getenv("SERVICE_NAME", "library-service")
    address      = os.getenv("SERVICE_ADDRESS", "library-service")
    ...
    atexit.register(lambda: consul.agent.service.deregister(service_id))
